                ...
                <div class="container">
                    <div class="row">
                        <div class="col s10 m6 l6">
                            <h5 class="breadcrumbs-title mt-0 mb-0"><span>Услуги</span></h5>
                        </div>
                                                ...
                                                <tr>
                                                    <td>
                                                        <img style="border-radius: 8px; border: 1px solid #ccc; max-width: 90px"
                                                             ...
                                                             src="{{$item->getFirstMediaUrl('service', 'thumb-p')}}"/>
                                                    </td>
                                                    ...
                                                    <td class="right">
                                                        ...
                                                        <form method="POST" action="{{route('admin.service.destroy', $item->id)}} "
                                                              class="col"
                                                        >
                                                            @csrf
                                                            @method('DELETE')
