            ...
            <div class="breadcrumbs-dark pb-0 pt-4" id="breadcrumbs-wrapper">
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col s10 m6 l6">
                                <h5 class="breadcrumbs-title mt-0 mb-0"><span>Настройки</span></h5>
                            </div>
                        </div>
                    </div>
                </div>
                @if ($item->exists)
                    <form method="POST" enctype="multipart/form-data"
                          action="{{route('admin.option.update', $item->id)}} ">
                        @method('PATCH')
                                                    ...
                                                    <div class="card-title">
                                                        <div class="row">
                                                            <div class="col s12 m6 l10">
                                                                ...
                                                                @endif
                                                                <p>
                                                                    Обратите внимание, e-mail который вы укажите будет
                                                                    использоваться как логин для входа в
                                                                    административную панель. А так же на него будут
                                                                    приходить все уведомления с сайта.
                                                                </p>
                                                            </div>
                                                        </div>
                                                    </div>
