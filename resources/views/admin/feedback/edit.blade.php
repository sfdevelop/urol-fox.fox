                                            ...
                                            <div class="card-title">
                                                <div class="row">
                                                    <div class="col s12 m6 l10">
                                                        ...
                                                        <div class="row">
                                                            <div class="col s12">
                                                                <h5>{{$contactQuestion->title}}</h5>
                                                            </div>
                                                            <div class="col s12">
                                                                <h6>{{$contactQuestion->mail}}</h6>
                                                            </div>
                                                            <div class="col s12">
                                                                <small>{{$contactQuestion->created_at->format('d/m/Y h:m:s')  ?? ""}}</small>
                                                            </div>

                                                            <div class="col s12">
                                                                <h5>Вопрос:</h5>
                                                                <p>{{$contactQuestion->question}}</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
