 ...
 * @property-read \Illuminate\Database\Eloquent\Collection|\Spatie\MediaLibrary\Models\Media[] $media
 * @property-read int|null $media_count
 * @property-read \App\Model\Category|null $parentCategory
 ...
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Model\Comment whereDate($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Model\Comment whereDescription($value)
 ...
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Model\Comment whereIsPublic($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Model\Comment whereName($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Model\Comment whereSort($value)
 ...
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Model\Order whereIsSee($value)
 ...
 * @property \Illuminate\Support\Carbon|null $created_at
 * @property \Illuminate\Support\Carbon|null $updated_at
 * @property-read \Illuminate\Database\Eloquent\Collection|\App\Model\Characteristic[] $characterProduct
 * @property-read int|null $character_product_count
